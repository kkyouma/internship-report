...
\usepackage[macchiato]{catppuccinpalette}
...
\setminted{
    ...
    breaklines,
    breaksymbolleft=,
    baselinestretch=0.9, % Reduced line spacing
    fontsize=\scriptsize,
}
...
\facultyto                  {FACULTAD DE INGENIER\'IA}
% \department               {}
% \faculty                  {}
\degree                     {Ingeniero Civil Industrial}
\advisor                    {Iv\'an Merino Rodr\'igez}
\supervisor                 {Luis Miguel Rond\'on}
